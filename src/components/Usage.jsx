    ...
    <div className="bg-[#022749] py-16 md:py-24">
      <div className="max-w-6xl mx-auto px-6 md:px-10">
        ...
        <div className="max-w-2xl mx-auto text-center mb-12">
          <span className="inline-flex items-center gap-2 bg-white/10 text-[#8FBCE8] text-sm font-semibold px-4 py-2 rounded-full mb-5">
            <Clock size={12} />
            সেবনবিধি
          </span>
          <h2 className="font-serif font-bold text-2xl md:text-4xl text-white">
